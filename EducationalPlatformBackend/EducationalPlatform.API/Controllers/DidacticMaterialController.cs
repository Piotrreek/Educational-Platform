...
using EducationalPlatform.Application.DidacticMaterial.Commands.CreateDidacticMaterial;
using EducationalPlatform.Application.DidacticMaterial.Commands.CreateDidacticMaterialOpinion;
using EducationalPlatform.Application.DidacticMaterial.Commands.CreateDidacticMaterialRating;
using EducationalPlatform.Application.DidacticMaterial.Commands.RemoveDidacticMaterialRating;
using EducationalPlatform.Application.DidacticMaterial.Queries.GetDidacticMaterial;
using EducationalPlatform.Application.DidacticMaterial.Queries.GetDidacticMaterialOpinions;
using EducationalPlatform.Application.DidacticMaterial.Queries.GetDidacticMaterials;
using MediatR;
